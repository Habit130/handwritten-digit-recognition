...
Issues and PRDs for `Habit130/handwritten-digit-recognition` live as GitHub issues. Use the `gh` CLI for all operations.
...
Resolve whether the ticket is a PR or issue, then fetch it with the corresponding `gh pr view` or `gh issue view` command.
